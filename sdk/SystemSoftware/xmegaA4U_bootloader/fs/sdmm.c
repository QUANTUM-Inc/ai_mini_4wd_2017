...
#define	CS_H()		(PORTC.OUTSET = (1 << 4))	/* Set MMC CS "high" */
#define CS_L()		(PORTC.OUTCLR = (1 << 4))	/* Set MMC CS "low" */
...
/*-----------------------------------------------------------------------*/
#define SCK_Lo()					(PORTC.OUTCLR = (1 << 7))
#define SCK_Hi()					(PORTC.OUTSET = (1 << 7))
...
)
{
	...
	PORTC.PIN4CTRL = ((PORTC.PIN4CTRL) & ~PORT_OPC_gm) | PORT_OPC_TOTEM_gc;
	PORTC.PIN5CTRL = ((PORTC.PIN5CTRL) & ~PORT_OPC_gm) | PORT_OPC_TOTEM_gc;
	PORTC.PIN6CTRL = ((PORTC.PIN6CTRL) & ~PORT_OPC_gm) | PORT_OPC_PULLUP_gc;
	PORTC.PIN7CTRL = ((PORTC.PIN7CTRL) & ~PORT_OPC_gm) | PORT_OPC_TOTEM_gc;
	...
	SPIC.CTRL    = SPI_ENABLE_bm | SPI_MASTER_bm | (SPI_CLK2X_bm) | (SPI_PRESCALER_DIV4_gc) | (SPI_DATA_ORDER_MSB_FIRST << SPI_DORD_bp) | SPI_MODE_0_gc;
